...
const NumberToWords = function(num){
    ...
    if(num === 0 ) return console.log("Please enter number greater then zero");
    if(helper[num]) return helper[num];
    breakIntoDigits(num);

    if(BreakedNumber.length > 4) return console.log("Number is too big");
    let string = "";
...
args.forEach(val => NumberToWords(val));

// Try this command
// node NumberToWordNode.js 6788999 667668967779 5667566876 6768686876868678876786867
